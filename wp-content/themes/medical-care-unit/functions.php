...
function medical_care_unit_redirect_get_started() {
	global $pagenow;
		if (isset($_GET['activated']) && ('themes.php' == $pagenow) && is_admin()) {
		wp_safe_redirect(admin_url("themes.php?page=medical-care-unit-theme.php"));
	}
}
add_action('after_setup_theme', 'medical_care_unit_redirect_get_started');
